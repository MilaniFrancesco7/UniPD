...
- **Accrescimento**: Progressiva associazione di altri atomi con aumento della fase cristallina e diminuzione del liquido
	- **Planare o Compatto**: I nuclei consumano la massa liquida creando un'interfaccia planare tra il solido e il liquido
...
- **Segregazioni**: Disomogeneità di composizione chimica che si osserva in una lega metallica solidificata, quando la solidificazione non avviene con una successione di stati di equilibrio.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc0MDM4MjQ3MywtMjA5Nzk5ODIwNSwxOT
Y5NzI1MjldfQ==
-->